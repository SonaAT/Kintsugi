...
def reformat_dialog_to_llama2(input_file, output_file):
    """
    Extracts the dialog between "usr" and "sys" from a dataset containing multiple records
    ...
    with open(input_file, 'r', encoding='utf-8') as f:
        data = json.load(f)  # Expecting a JSON array
...
# Example usage
# Replace 'input.json' with the path to your dataset
# Replace 'output.txt' with the desired output file path
reformat_dialog_to_llama2('input.json', 'output.txt')
